...
const STOP_NAMES: Record<ResolvedLanguage, Record<string, string>> = {
  en: {
    ...
    '1:857': 'Gergeti Street',
    '1:4673': 'Mikheil Lermontov Street',
    '1:3078': 'Kojori Center',
    '1:4186': 'Kojori, Niko Ketskhoveli Street',
    '1:2856': 'Kojori, Vazha-Pshavela St #56',
    '1:2139': 'Kojori Zakaria Bakradze Street',
  ...
  ka: {
    ...
    '1:4186': 'კოჯორი, ნიკო კეცხოველის ქუჩა',
    '1:2856': 'კოჯორი, ვაჟა-ფშაველას ქ. #56',
    '1:2139': 'კოჯორი, ზაქარია ბაქრაძის ქუჩა',
  ...
  ru: {
    ...
    '1:4186': 'Коджори, улица Нико Кецховели',
    '1:2856': 'Коджори, ул. Важа-Пшавела, 56',
    '1:2139': 'Коджори, улица Закарии Бакрадзе',
